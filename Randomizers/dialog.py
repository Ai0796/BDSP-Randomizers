...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cbEncounterLevel = QtWidgets.QCheckBox(self.groupBox_3)
        self.cbEncounterLevel.setChecked(True)
        self.cbEncounterLevel.setObjectName("cbEncounterLevel")
        self.gridLayout_2.addWidget(self.cbEncounterLevel, 1, 0, 1, 1)
        self.cbTrainerLevel = QtWidgets.QCheckBox(self.groupBox_3)
        self.cbTrainerLevel.setChecked(True)
        self.cbTrainerLevel.setObjectName("cbTrainerLevel")
        self.gridLayout_2.addWidget(self.cbTrainerLevel, 0, 0, 1, 1)
        self.sbTrainerLevel = QtWidgets.QDoubleSpinBox(self.groupBox_3)
        self.sbTrainerLevel.setDecimals(0)
        self.sbTrainerLevel.setMinimum(-50.0)
        self.sbTrainerLevel.setMaximum(500.0)
        self.sbTrainerLevel.setSingleStep(10.0)
        self.sbTrainerLevel.setProperty("value", 0.0)
        self.sbTrainerLevel.setObjectName("sbTrainerLevel")
        self.gridLayout_2.addWidget(self.sbTrainerLevel, 4, 0, 1, 1)
        ...
        self.sbEncounterLevel = QtWidgets.QDoubleSpinBox(self.groupBox_3)
        self.sbEncounterLevel.setDecimals(0)
        self.sbEncounterLevel.setMinimum(-50.0)
        self.sbEncounterLevel.setMaximum(500.0)
        self.sbEncounterLevel.setSingleStep(10.0)
        self.sbEncounterLevel.setObjectName("sbEncounterLevel")
        self.gridLayout_2.addWidget(self.sbEncounterLevel, 6, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.checkBox_3, 10, 0, 1, 1)
        self.checkBox_8 = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        self.checkBox_8.setObjectName("checkBox_8")
        self.gridLayout_5.addWidget(self.checkBox_8, 9, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.cbTrueSize, 4, 0, 1, 1)
...
" encounters"))
        ...
        self.cbEncounterLevel.setText(_translate("MainWindow", "Encounter Level Multiplier"))
        self.cbTrainerLevel.setText(_translate("MainWindow", "Trainer Level Multiplier"))
        self.sbTrainerLevel.setSuffix(_translate("MainWindow", "%"))
        self.label_3.setText(_translate("MainWindow", "Trainer Increase%"))
        self.label_6.setText(_translate("MainWindow", "Encounter Increase%"))
        self.sbEncounterLevel.setSuffix(_translate("MainWindow", "%"))
...
"Amount"))
        ...
        self.cbCameras.setText(_translate("MainWindow", "Coming Soon"))
...
" Texture mods won\'t be added out of complexity"))
        self.cbRemoveWeather.setText(_translate("MainWindow", "Remove Fog/Heavy Snow + Add Biking Everywhere"))
        self.cbFollowing.setText(_translate("MainWindow", "HG/SS Following Style + Fixed Static Animations (Does not include new animations, you\'ll need to download Yisuno\'s mod for that)"))
